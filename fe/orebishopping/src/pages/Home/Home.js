    ...
    <div className="w-full mx-auto">
      ...
      <div className="flex justify-between w-full mx-auto px-4">
        ...
        <div className="w-4/5">
          ...
          {/* Render NewArrivals with a button to navigate to CategoryDetailPage */}
          <div>
            <NewArrivals />
            {/* Nút "Xem thêm" sẽ đưa người dùng đến trang chi tiết category */}
            <div className="mt-4 text-center">
              <Link 
                to="/category/new-arrivals"  // Đổi theo tên category cần thiết
